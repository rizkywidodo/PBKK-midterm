        ...
        <div class="contact-sec py-5">
            <div class="container py-md-4 py-3">
                <div class="contact-w3pvt-form">
                    ...
                    <form action="login" method="POST" class="w3layouts-contact-fm">
                            @csrf                   
                        ...
                        <div class="form-group-2 mt-4">
                            <button type="submit" class="btn button-style ">Login</button>
                        </div>
                        <div class="form-group-2 mt-4">
                        <a class="btn button-style" href="{{url('register')}}">Register</a>
                    </div>
                    </form>
                </div>
            </div>
