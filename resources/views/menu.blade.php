        ...
        <div class="container py-md-4 py-3">
            ...
            <div class="row menu-body">
                ...
                <div class="col-lg-6 menu-section">
                    ...
                    <div class="row menu-item">
                        <div class="col-3 p-0 position-relative">
                            <img src="{{url('assets/images/menu1.jpg')}}" class="img-responsive" alt="">
                    ...
                    <div class="row menu-item">
                        <div class="col-3 p-0 position-relative">
                            <img src="{{url('assets/images/menu2.jpg')}}" class="img-responsive" alt="">
                            <a href="#order" class="btn button-style button-style-2">Add</a>
                        </div>
                        <div class="col-9 pl-4">
                            <div class="row no-gutters">
                    ...
                    <div class="row menu-item">
                        <div class="col-3 p-0 position-relative">
                            <img src="{{url('assets/images/menu3.jpg')}}" class="img-responsive" alt="">
                            <a href="#order" class="btn button-style button-style-2">Add</a>
                        </div>
                        <div class="col-9 pl-4">
                            <div class="row no-gutters">
                    ...
                    <div class="row menu-item">
                        <div class="col-3 p-0 position-relative">
                            <img src="{{url('assets/images/menu4.jpg')}}" class="img-responsive" alt="">
                            <a href="#order" class="btn button-style button-style-2">Add</a>
                        </div>
                        <div class="col-9 pl-4">
                            <div class="row no-gutters">
                ...
                <div class="col-lg-6 menu-section pl-lg-5">
                    ...
                    <div class="row menu-item">
                        <div class="col-3 p-0 position-relative">
                            <img src="{{url('assets/images/menu5.jpg')}}" class="img-responsive" alt="">
                            <a href="#order" class="btn button-style button-style-2">Add</a>
                        </div>
                        <div class="col-9 pl-4">
                            <div class="row no-gutters">
                    ...
                    <div class="row menu-item">
                        <div class="col-3 p-0 position-relative">
                            <img src="{{url('assets/images/menu6.jpg')}}" class="img-responsive" alt="">
                            <a href="#order" class="btn button-style button-style-2">Add</a>
                        </div>
                        <div class="col-9 pl-4">
                            <div class="row no-gutters">
                    ...
                    <div class="row menu-item">
                        <div class="col-3 p-0 position-relative">
                            <img src="{{url('assets/images/menu7.jpg')}}" class="img-responsive" alt="">
                            <a href="#order" class="btn button-style button-style-2">Add</a>
                        </div>
                        <div class="col-9 pl-4">
                            <div class="row no-gutters">
                    ...
                    <div class="row menu-item">
                        <div class="col-3 p-0 position-relative">
                            <img src="{{url('assets/images/menu8.jpg')}}" class="img-responsive" alt="">
                            <a href="#order" class="btn button-style button-style-2">Add</a>
                        </div>
                        <div class="col-9 pl-4">
                            <div class="row no-gutters">
            ...
            <div class="another-sec">
                ...
                <div class="row menu-body">
                    ...
                    <div class="col-lg-6 menu-section pr-lg-5">
                        ...
                        <div class="row menu-item">
                            <div class="col-3 p-0 position-relative">
                                <img src="{{url('assets/images/menu9.jpg')}}" class="img-responsive" alt="">
                                <a href="#order" class="btn button-style button-style-2">Add</a>
                            </div>
                            <div class="col-9 pl-4">
                                <div class="row no-gutters">
                        ...
                        <div class="row menu-item">
                            <div class="col-3 p-0 position-relative">
                                <img src="{{url('assets/images/menu10.jpg')}}" class="img-responsive" alt="">
                                <a href="#order" class="btn button-style button-style-2">Add</a>
                            </div>
                            <div class="col-9 pl-4">
                                <div class="row no-gutters">
                        ...
                        <div class="row menu-item">
                            <div class="col-3 p-0 position-relative">
                                <img src="{{url('assets/images/menu11.jpg')}}" class="img-responsive" alt="">
                                <a href="#order" class="btn button-style button-style-2">Add</a>
                            </div>
                            <div class="col-9 pl-4">
                                <div class="row no-gutters">
                    ...
                    <div class="col-lg-6 menu-section pl-lg-5">
                        ...
                        <div class="row menu-item">
                            <div class="col-3 p-0 position-relative">
                                <img src="{{url('assets/images/menu12.jpg')}}" class="img-responsive" alt="">
                                <a href="#order" class="btn button-style button-style-2">Add</a>
                            </div>
                            <div class="col-9 pl-4">
                                <div class="row no-gutters">
                        ...
                        <div class="row menu-item">
                            <div class="col-3 p-0 position-relative">
                                <img src="{{url('assets/images/menu13.jpg')}}" class="img-responsive" alt="">
                                <a href="#order" class="btn button-style button-style-2">Add</a>
                            </div>
                            <div class="col-9 pl-4">
                                <div class="row no-gutters">
                        ...
                        <div class="row menu-item">
                            <div class="col-3 p-0 position-relative">
                                <img src="{{url('assets/images/menu14.jpg')}}" class="img-responsive" alt="">
                                <a href="#order" class="btn button-style button-style-2">Add</a>
                            </div>
                            <div class="col-9 pl-4">
                                <div class="row no-gutters">
